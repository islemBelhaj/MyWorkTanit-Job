...
#[Route('Back/employeur/offre/emploi')]
class OffreEmploiController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('Back/employeur/offre_emploi/new.html.twig', [
    ...
    {
        return $this->render('Back/employeur/offre_emploi/show.html.twig', [
            'offre_emploi' => $offreEmploi,
        ]);
    }
    ...
    public function edit(Request $request, OffreEmploi $offreEmploi, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('Back/employeur/offre_emploi/edit.html.twig', [
            'offre_emploi' => $offreEmploi,
            'form' => $form,
        ]);
    }
