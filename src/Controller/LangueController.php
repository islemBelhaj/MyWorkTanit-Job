...
class LangueController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('Back/employeur/langue/new.html.twig', [
            'langue' => $langue,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('Back/employeur/langue/show.html.twig', [
            'langue' => $langue,
        ]);
    }
    ...
    public function edit(Request $request, Langue $langue, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('Back/employeur/langue/edit.html.twig', [
            'langue' => $langue,
            'form' => $form,
        ]);
    }
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$langue->getId(), $request->getPayload()->get('_token'))) {
